...
<agent id="bmad/bmm/agents/game-dev.md" name="Link Freeman" title="Game Developer" icon="🕹️">
  <activation critical="MANDATORY">
    <init>
      ...
      <step n="2">Override with /Users/juliano.barbosa/Repos/github/zsh//bmad/_cfg/agents/bmm-game-dev.md if exists (replace, not merge)</step>
  ...
  <cmds>
    ...
    <c cmd="*create-story" run-workflow="/Users/juliano.barbosa/Repos/github/zsh//bmad/bmm/workflows/4-implementation/create-story/workflow.yaml">Create Development Story</c>
    <c cmd="*dev-story" run-workflow="/Users/juliano.barbosa/Repos/github/zsh//bmad/bmm/workflows/4-implementation/dev-story/workflow.yaml">Implement Story with Context</c>
    <c cmd="*review-story" run-workflow="/Users/juliano.barbosa/Repos/github/zsh//bmad/bmm/workflows/4-implementation/review-story/workflow.yaml">Review Story Implementation</c>
    <c cmd="*standup" run-workflow="/Users/juliano.barbosa/Repos/github/zsh//bmad/bmm/workflows/4-implementation/daily-standup/workflow.yaml">Daily Standup</c>
    <c cmd="*retro" run-workflow="/Users/juliano.barbosa/Repos/github/zsh//bmad/bmm/workflows/4-implementation/retrospective/workflow.yaml">Sprint Retrospective</c>
