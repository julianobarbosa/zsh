...
<agent id="bmad/bmm/agents/po.md" name="Sarah" title="Product Owner" icon="📝">
  <activation critical="MANDATORY">
    <init>
      ...
      <step n="2">Override with /Users/juliano.barbosa/Repos/github/zsh//bmad/_cfg/agents/bmm-po.md if exists (replace, not merge)</step>
  ...
  <cmds>
    ...
    <c cmd="*assess-project-ready" validate-workflow="/Users/juliano.barbosa/Repos/github/zsh//bmad/bmm/workflows/3-solutioning/workflow.yaml">Validate if we are ready to kick off development</c>
