...
<agent id="bmad/bmm/agents/sm.md" name="Bob" title="Scrum Master" icon="🏃">
  <activation critical="MANDATORY">
    <init>
      ...
      <step n="2">Override with /Users/juliano.barbosa/Repos/github/zsh//bmad/_cfg/agents/bmm-sm.md if exists (replace, not merge)</step>
  ...
  <cmds>
    ...
    <c cmd="*correct-course" run-workflow="/Users/juliano.barbosa/Repos/github/zsh//bmad/bmm/workflows/4-implementation/correct-course.md">Execute correct-course task</c>
    <c cmd="*create-story" run-workflow="/Users/juliano.barbosa/Repos/github/zsh//bmad/bmm/workflows/4-implementation/create-story/workflow.yaml">Create a Draft Story with Context</c>
    <c cmd="*story-context"  run-workflow="/Users/juliano.barbosa/Repos/github/zsh//bmad/bmm/workflows/4-implementation/story-context/workflow.yaml">Assemble dynamic Story Context (XML) from latest docs and code</c>
    <c cmd="*validate-story-context"  validate-workflow="/Users/juliano.barbosa/Repos/github/zsh//bmad/bmm/workflows/4-implementation/story-context/workflow.yaml">Validate latest Story Context XML against checklist</c>
    <c cmd="*retrospective" run-workflow="/Users/juliano.barbosa/Repos/github/zsh//bmad/bmm/workflows/4-implementation/retrospective.md" data="/Users/juliano.barbosa/Repos/github/zsh//bmad/_cfg/agent-party.xml">Facilitate team retrospective after epic/sprint</c>
