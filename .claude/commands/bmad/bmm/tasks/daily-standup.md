...
<task id="bmad/bmm/tasks/daily-standup.md" name="Daily Standup">
  ...
  <flow>
    <step n="1" title="Project Context Discovery">
      <action>Check for stories folder at /Users/juliano.barbosa/Repos/github/zsh/{output_folder}/stories/ directory</action>
...
{{ List Agents from /Users/juliano.barbosa/Repos/github/zsh//bmad/_cfg/agent-party.xml }}
      </output>
    </step>
...
Need extended discussion? Use *party-mode for detailed breakout.
  ...
  <activation critical="MANDATORY">
    <init>
      ...
      <step n="2">Override with /Users/juliano.barbosa/Repos/github/zsh//bmad/_cfg/agents/bmm-daily-standup.md if exists (replace, not merge)</step>
