...
<task id="bmad/bmm/tasks/retrospective.md" name="Team Retrospective">
  ...
  <flow>
    <step n="1" title="Epic Context Discovery">
      <action>Check /Users/juliano.barbosa/Repos/github/zsh/{output_folder}/stories/ for highest completed story</action>
      <action>Extract epic number from story (e.g., "Epic: 003")</action>
      <action>Read epic from /Users/juliano.barbosa/Repos/github/zsh/{output_folder}/prd/epic{number}.md</action>
      <action>List all stories for this epic in /Users/juliano.barbosa/Repos/github/zsh/{output_folder}/stories/</action>
    ...
    <step n="2" title="Preview Next Epic">
      <action>Read next epic from d/Users/juliano.barbosa/Repos/github/zsh/{output_folder}/prd/epic{next-number}.md</action>
