...
<agent id="bmad/cis/agents/brainstorming-coach.md" name="Carson" title="Elite Brainstorming Specialist" icon="🧠">
  <activation critical="MANDATORY">
    <init>
      ...
      <step n="2">Override with /Users/juliano.barbosa/Repos/github/zsh//bmad/_cfg/agents/cis-brainstorming-coach.md if exists (replace, not merge)</step>
  ...
  <cmds>
    ...
    <c cmd="*brainstorm" run-workflow="/Users/juliano.barbosa/Repos/github/zsh//bmad/cis/workflows/brainstorming/workflow.yaml">Guide me through Brainstorming</c>
